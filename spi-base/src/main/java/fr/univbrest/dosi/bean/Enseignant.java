...
public class Enseignant implements Serializable {
	...
	public Enseignant(long noEnseignant, String emailPerso, String mobile, String pays, String telephone) {
	...
	public Enseignant(long noEnseignant, String nom, String pays) {
		super();
		this.noEnseignant = noEnseignant;
		this.nom = nom;
		this.pays = pays;
